...
MODULES = [
    ...
    "app.v2.repositories.financing_events",
    "app.v2.domain.financing_resolution",
    "app.v2.financing_resolution",
    "app.v2.financing_resolution.errors",
    "app.v2.financing_resolution._writes",
    "app.v2.financing_resolution.promotion",
    "app.v2.migrations.versions.0009_create_financing_event_and_resolution",
    "app.v2.domain.taxonomy",
    "app.v2.domain.capital_metrics",
    "app.v2.repositories.markets",
    "app.v2.repositories.capital_metrics",
    "app.v2.classification",
    "app.v2.classification.errors",
    "app.v2.classification._writes",
    "app.v2.classification.service",
    "app.v2.migrations.versions.0010_create_market_taxonomy_and_classification",
